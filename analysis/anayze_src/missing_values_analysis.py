...
# Subclass must implement the method to identify and visualize the missing values

class MissingValuesAnalysisTemplate(ABC):
    def analyze(self , df: pd.DataFrame):
        """
        Perform a complete missing value analysis by identifying and visualizing missing values.

        Parameters:
        df (pd.DataFrame): The dataframe to be analyzed.

        Returns:
        None : This method perform the analysis and visualizes missing values
        """
